...
bool EFP::downloadChapter(QStringList chapterUrls, int chapterIndex)
{
	...
	s = MyUtils::advancedReplace(s, "</title><table width=\"100%\"", "<center><p class=\"title", "</title><center><p class=\"title");
	s = s.replace("</td></tr></table>\n<p align=\"right\"><big><a href=\"#top\">Ritorna all'indice</a></big></p><hr>", "<p align=\"right\"><big><a href=\"#top\">Ritorna all'indice</a></big></p><br style='page-break-before:always;mso-break-type:section-break'>");
	s = s.replace("***</p></center><br>\n<table><tr><td>", "***</p></center><br>\n");
	s = s.replace("</p><br><br>\n\n<table><tr><td>", "</p><br><br>\n\n");

	Website::story = "<html><head><meta http-equiv=Content-Type content=\"text/html; charset=windows-1252\"></head>\n" + s;
